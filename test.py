...
parser.add_arguemtn('-l',help = 'Total length of the sequence', default = 200)
parser.add_arguemtn('-o',help = 'Name of the output fasta file', default = None)
parser.add_arguemtn('-f',help = 'The reference fasta file', default = 'None')
